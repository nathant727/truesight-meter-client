...
import com.bmc.truesight.saas.meter.client.command.ImmutableTypedExpression;
import com.bmc.truesight.saas.meter.client.command.ImmutableTypedNumber;
...
public class MeterRpcHandlerTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (TruesightRpcClient client = new TruesightRpcClient(config)) {
